...
def main():  # 定义函数main()
    ...
    def show_data(weather_dict, city_name):  # 显示数据
        ...
        root1 = Tk()  # 副窗口
        root1.geometry('800x500')  # 修改窗口大小
        root1.resizable(0, 0)  # 禁止调整窗口大小
        ...
        Label(root1, text="我的技术博客：https://github.com/lijuncheng1993", fg="green", bg="white").place(x=20, y=450, width=480,
                                                                                height=20)  # 作者网站
        Button(root1, text='确认并退出', width=10, command=root1.quit).place(x=500, y=400, width=80, height=40)  # 退出按钮
        root1.mainloop()
